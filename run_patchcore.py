...
def main():
    ...
    parser.add_argument("--use_augmented", action="store_true", help="Use augmented defects")
    parser.add_argument("--num_augmented", type=int, default=150, help="Number of augmented defects")
    ...
    crops_dataset = KolektorSDD2Crops(
        ...
        add_augmented=args.use_augmented,
        augmented_crop_root=args.crops_path
    )
